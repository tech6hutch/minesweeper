...
pub fn run() -> Config {
    ...
    while window.is_open() && !window.is_key_down(Key::Escape) {
        ...
        draw_rectangle((5, 5), (100, font.scale().y as usize + 10), COLOR_BUTTON, &mut buffer, WINDOW_WIDTH);
        let mut btn_glyphs = Vec::new();
        _ = text::layout_paragraph(&font, point(10.0, 10.0), f32::INFINITY, "English", &mut btn_glyphs);
        text::draw_glyphs(btn_glyphs.into_iter(), (0, 0), &font, COLOR_BUTTON_TEXT, &mut buffer, WINDOW_WIDTH);
